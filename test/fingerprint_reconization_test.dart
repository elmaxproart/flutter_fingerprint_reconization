...
void main() {
  final FingerprintReconizationPlatform initialPlatform = FingerprintReconizationPlatform.instance;

  test('$MethodChannelFingerprintReconization is the default instance', () {
    expect(initialPlatform, isInstanceOf<MethodChannelFingerprintReconization>());
  });

  test('getPlatformVersion', () async {
    FingerprintReconization fingerprintReconizationPlugin = FingerprintReconization();
    MockFingerprintReconizationPlatform fakePlatform = MockFingerprintReconizationPlatform();
